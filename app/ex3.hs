{- Adapted from https://github.com/KerfuffleV2/haskell-polysemy-test/blob/3ba61c17f6ff8b91b2cf789deb87ec6e2884bcdb/src/example3/Main.hs -}
...
readInputIO :: Member (Embed IO) r => Sem (Input String ': r) a -> Sem r a
readInputIO = interpret \case
  Input -> embed getLine
